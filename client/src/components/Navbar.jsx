        ...
        <div className='flex items-center gap-6 relative'>
          ...
          <div className='relative'>
            <button onClick={() => {
              ...
              setShowUserPopup(!showUserPopup); setShowCreditPopup(false) }} className='flex items-center justify-center bg-black text-white w-9 h-9 rounded-full font-semibold'>
