      ...
      <div className='w-full max-w-6xl bg-white rounded-3xl shadow-2xl grid md:grid-cols-2 overflow-hidden'>
          ...
          className='relative bg-linear-to-br from-green-50 to-green-100 p-12 flex flex-col justify-center '>
              ...
              <p className='text-gray-600 mb-10'>
                Practice real interview scenarios powered by AI. Improve Communication skills, Technical skills, and confidence.
              </p>
              ...
              <div className='space-y-5'>
                {
                  [
                    ...
                    initial={{y:30, opacity: 0}} animate={{y:0, opacity:1}} transition={{ delay:0.3 + index * 0.15}} whileHover={{scale: 1.03}}
          ...
          className='p-12 bg-white'>
              ...
              <h2 className='text-3xl font-3xl font-bold text-gray-800 mb-8'>
                Interview SetUp
              </h2>
              ...
              <div className='space-y-6'>
                ...
                <select value={mode}  
                  ...
                  {analysisDone && (
                    ...
                    className='bg-gray-50 border-gray-200 border rounded-xl p-5 space-y-4'>
