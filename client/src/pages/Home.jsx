                ...
                className={`relative bg-white rounded-3xl border-2 border-green-100 hover:border-green-500 p-10 w-80 max-w-[90%] shadow-md hover:shadow-2xl
                  ...
                  `}>
                    ...
                    <div className='pt-10 text-center'>
                      <div className='text-lg text-green-600 font-semibold mb-2 tracking-wider'>{item.step}</div>
                  ...
                  [
                    {
                      ...
                      desc: "Scores communications, technical accuracy and confidence."
                    },
                    {
                      image: resumeImg,
                    ...
                    },
                    {
                      ...
                      desc: "Deatiled Strengths, weakness and improvement insights."
                    },
                    {
                      image: analyticsImg,
                      icon: <BsBarChart size={20}/>,
                  ...
                  [
                    ...
                    className='bg-white border border-gray-200 rounded-3xl p-8 shadow-sm hover:shadow-xl transition-all'>
                      ...
                      <div className='flex items-center justify-between gap-6'>
                        <div className='w-1/2'>
                          <h3 className='font-semibold mb-3 text-xl'>{item.title}</h3>
                          <p className='text-gray-500 text-m leading-relaxed'>{item.desc}</p>
                        </div>

                        <div className='w-1/2 flex justify-end'>
                          <img src={item.image} alt={item.title} className='w-35 h-35 object-contain' />
                        </div>
                      </div>
                    </motion.div>
                  ))
